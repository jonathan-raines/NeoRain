...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-comment', 'octo.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'null-ls.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-treesitter'}, { event = "CursorHold *" }, _G.packer_plugins)]]
...
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'tokyonight.nvim', 'nvim-tree.lua', 'harpoon', 'lualine.nvim', 'which-key.nvim'}, { event = "UIEnter *" }, _G.packer_plugins)]]
