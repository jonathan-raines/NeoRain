...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'harpoon', 'octo.nvim', 'nvim-comment'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'null-ls.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'lualine.nvim', 'nvim-tree.lua', 'tokyonight.nvim'}, { event = "UIEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'gitsigns.nvim', 'which-key.nvim', 'nvim-treesitter'}, { event = "CursorHold *" }, _G.packer_plugins)]]
