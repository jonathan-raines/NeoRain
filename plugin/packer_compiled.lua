...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'nvim-treesitter', 'gitsigns.nvim'}, { event = "CursorHold *" }, _G.packer_plugins)]]
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'lualine.nvim', 'which-key.nvim', 'nvim-tree.lua', 'tokyonight.nvim', 'harpoon'}, { event = "UIEnter *" }, _G.packer_plugins)]]
