...
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'nvim-tree.lua', 'lualine.nvim', 'tokyonight.nvim'}, { event = "UIEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-comment', 'harpoon', 'octo.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
