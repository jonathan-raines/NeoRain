...
vim.cmd [[au FileType vue ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'nvim-lsp-ts-utils', 'nvim-ts-autotag'}, { ft = "vue" }, _G.packer_plugins)]]
...
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'tokyonight.nvim', 'nvim-tree.lua', 'lualine.nvim'}, { event = "UIEnter *" }, _G.packer_plugins)]]
