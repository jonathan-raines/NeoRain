...
M.init = function()
  ...
  vim.keymap.set('n', '<leader>hd', function() require 'grapple'.select { key = 2 } end, { desc = 'Select Tag 2' })
  vim.keymap.set('n', '<leader>hs', function() require 'grapple'.select { key = 3 } end, { desc = 'Select Tag 3' })
  vim.keymap.set('n', '<leader>ha', function() require 'grapple'.select { key = 4 } end, { desc = 'Select Tag 4' })
end
