return {
  ...
  config = function()
    ...
    \  { 'name': 'rooms_backend_develop', 'url': 'postgres://postgres:welcome@localhost:5432/rooms_backend_development' },
    \  { 'name': 'rooms_backend_test', 'url': 'postgres://postgres:welcome@localhost:5432/rooms_backend_test' }
    \ ]
  ]]
