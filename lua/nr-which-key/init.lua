...
local mappings = {
    ...
    n = {
        ...
        dc = {"<cmd>lua vim.lsp.buf.declaration()<cr>", "Declaration"}, -- Most servers use definition
        ...
        co = {"<cmd>lua vim.lsp.buf.outgoing_calls()<cr>", "List Outgoing Calls"},
        ...
        br = {"<cmd>lua vim.lsp.buf.references()<cr>", "References"},
